...
public class CallManager {
	...
	public void inviteAddress(LinphoneAddress lAddress, boolean videoEnabled, boolean lowBandwidth, boolean isMonitoring) throws LinphoneCoreException {
		...
		//CYY
		if(isMonitoring)
			params.addCustomHeader(LinphoneManager.HEARDER_IS_MONITORING, LinphoneManager.VALUE_TRUE);
		else
			params.addCustomHeader(LinphoneManager.HEARDER_IS_MONITORING, LinphoneManager.VALUE_FALSE);
		
		params.addCustomHeader(LinphoneManager.HEARDER_IS_ONLYVIDEO, LinphoneManager.VALUE_FALSE);   //add by jimmy at 2014.5.9
	...
	//add by jimmy at 2014.5.8 for only video conversation
	public void inviteAddress(LinphoneAddress lAddress, boolean videoEnabled, boolean lowBandwidth, boolean isMonitoring,boolean onlyVideo) throws LinphoneCoreException {
		LinphoneCore lc = LinphoneManager.getLc();
		...
		//add by jimmy at 2014.5.8
		params.addCustomHeader(LinphoneManager.HEARDER_IS_DIP40, LinphoneManager.VALUE_TRUE);
		params.addCustomHeader(LinphoneManager.HEARDER_IS_ONLYVIDEO, LinphoneManager.VALUE_FALSE);
