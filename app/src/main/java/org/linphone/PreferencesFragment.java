...
public class PreferencesFragment extends PreferencesListFragment implements EcCalibrationListener {
	...
	public void onCreate(Bundle bundle) {
		...
		ecCalibratePref = findPreference(R.string.pref_echo_canceller_calibration_key);
		...
		ecPref = (CheckBoxPreference) findPreference(R.string.pref_echo_cancellation_key);
		mencPref = (ListPreference) findPreference(R.string.pref_media_encryption_key);
	...
	private synchronized void startEcCalibration() {
		try {
			...
			ecCalibratePref.setSummary(R.string.ec_calibrating);
			ecCalibratePref.getEditor().putBoolean(getString(R.string.pref_echo_canceller_calibration_key), false).commit();
	...
	private void initializeTransportPreferences() {		
		...
		ListPreference transport = (ListPreference) findPreference(R.string.pref_transport_key);
