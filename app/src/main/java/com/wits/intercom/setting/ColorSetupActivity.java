...
public class ColorSetupActivity extends FragmentActivity {
	...
	private Handler mHandle = new Handler() {
		public void dispatchMessage(android.os.Message msg) {
			...
			if(msg.what == CLEAR_INPUT_MESSAGE ){
				...
				startActivity(new Intent(ColorSetupActivity.this,LinphoneWelcomeActivity.class));
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_color_setup);
	}
	...
	public boolean dispatchKeyEvent(KeyEvent event) {  
	   ...
	   if(event.getAction() == KeyEvent.ACTION_DOWN){
		...
		if(keyCode == 19){                       //left up
			   Intent mColorIntent = new Intent(this,KeyColorActivity.class);
			   mColorIntent.putExtra("type", "key");
			   ...
			   Intent mColorIntent = new Intent(this,KeyColorActivity.class);
			   mColorIntent.putExtra("type", "board");
			   startActivity(mColorIntent);
			   return true;
