...
public class SystemSetupActivity extends FragmentActivity {
	...
	private Handler mHandle = new Handler() {
		public void dispatchMessage(android.os.Message msg) {
			...
			if(msg.what == CLEAR_INPUT_MESSAGE ){
				...
				startActivity(new Intent(SystemSetupActivity.this,LinphoneWelcomeActivity.class));
			}
	...
	public boolean dispatchKeyEvent(KeyEvent event) {  
	   ...
	   if(event.getAction() == KeyEvent.ACTION_DOWN){
		  ...
		  if(keyCode == 19){                       //left up
			   Intent mSystemSummaryIntent = new Intent(this,SystemSummaryActivity.class);
			   startActivity(mSystemSummaryIntent);
			   return true;
...
//			   MyApplication.getInstnce().back(2);
			   ...
			   Intent mSetIpIntent = new Intent(this,UserInputActivity.class);
			   mSetIpIntent.putExtra("type", "SET_IP");
			   startActivity(mSetIpIntent);
			   
			   return true;
			   
		   }else if(keyCode == 22){        //right down
			   Intent mSystemPasswordIntent = new Intent(this,SystemPasswordActivity.class);
			   startActivity(mSystemPasswordIntent);
			   return true;
