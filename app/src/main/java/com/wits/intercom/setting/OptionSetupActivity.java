...
public class OptionSetupActivity extends FragmentActivity {
	...
	private Handler mHandle = new Handler() {
		public void dispatchMessage(android.os.Message msg) {
			...
			if(msg.what == CLEAR_INPUT_MESSAGE ){
				...
				startActivity(new Intent(OptionSetupActivity.this,LinphoneWelcomeActivity.class));
			}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_option_setup);
	}
	...
	public boolean dispatchKeyEvent(KeyEvent event) {  
	   ...
	   if(event.getAction() == KeyEvent.ACTION_DOWN){
		...
		if(keyCode == 19){                       //left up
			   ...
			   Intent mSetApartmentIntent = new Intent(this,UserInputActivity.class);
