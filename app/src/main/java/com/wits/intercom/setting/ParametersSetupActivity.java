...
public class ParametersSetupActivity extends FragmentActivity {
	...
	private Handler mHandle = new Handler() {
		public void dispatchMessage(android.os.Message msg) {
			...
			if(msg.what == CLEAR_INPUT_MESSAGE ){
				...
				startActivity(new Intent(ParametersSetupActivity.this,LinphoneWelcomeActivity.class));
			}
	...
	public boolean dispatchKeyEvent(KeyEvent event) {  
	   ...
	   if(event.getAction() == KeyEvent.ACTION_DOWN){
		...
		if(keyCode == 19){                       //left up
			   Intent mColorIntent = new Intent(this,ColorSetupActivity.class);
			   startActivity(mColorIntent);
			   return true;
			   
		   }else if(keyCode == 20){            //left down
//			   MyApplication.getInstnce().back(2);
			   Intent mSystemSetupIntent = new Intent(this,SettingActivity.class);
			   startActivity(mSystemSetupIntent);
			   return true;
			   
		   }else if(keyCode == 21){          //right up
			   Intent mLanguageIntent = new Intent(this,LanguageSetupActivity.class);
			   startActivity(mLanguageIntent);
			   return true;
			   
		   }else if(keyCode == 22){        //right down
			   Intent mNextIntent = new Intent(this,DoorReleaseDurationActivity.class);
