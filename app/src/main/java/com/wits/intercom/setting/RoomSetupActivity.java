...
public class RoomSetupActivity extends FragmentActivity {
	...
	private Handler mHandle = new Handler() {
		public void dispatchMessage(android.os.Message msg) {
			...
			if(msg.what == CLEAR_INPUT_MESSAGE ){
				...
				startActivity(new Intent(RoomSetupActivity.this,LinphoneWelcomeActivity.class));
			}
	...
	public boolean dispatchKeyEvent(KeyEvent event) {  
	   ...
	   if(event.getAction() == KeyEvent.ACTION_DOWN){
		...
		if(keyCode == 19){                       //left up
			   Intent mEditNameIntent = new Intent(this,UserInputActivity.class);
			   mEditNameIntent.putExtra("type", "EDIT_NAME");
			   startActivity(mEditNameIntent);
			   return true;
			   ...
			   Intent mAddCardIntent = new Intent(this,UserInputActivity.class);
			   mAddCardIntent.putExtra("type", "ADD_CARD");
			   startActivity(mAddCardIntent);
			   return true;
			   
		   }else if(keyCode == 22){        //right down
			   Intent mDeleteCardIntent = new Intent(this,UserInputActivity.class);
			   mDeleteCardIntent.putExtra("type", "DELETE_CARD");
			   startActivity(mDeleteCardIntent);
			   return true;
