...
public interface LinphoneCore {
	 ...
	 * @return org.linphone call
	 * @throws LinphoneCoreException if org.linphone call cannot be created
	 */
	 ...
	 * @param call the LinphoneCall, must be in the {@link State#IncomingReceived} state.
	...
	**/
	...
	/**
	 * destroy org.linphone core and free all underlying resources
	 */
	public void destroy();
	/**
	...
	/**
	 * Set transport ports org.linphone core will listen on
	...
	/**
	 * Create a new chat room for messaging from a sip uri like sip:joe@sip.org.linphone.org
	...
	**/
	 ...
	 * @param stun_server Stun server address and port, such as stun.org.linphone.org or stun.org.linphone.org:3478
	 */
	...
	**/
	...
	/**
	 * Get default call parameters reflecting current org.linphone core configuration
	...
	**/
	 ...
	 * @param call an established call, either in {@link State#StreamsRunning} or {@link State#Paused} state.
	 * 
	**/
	 ...
	 * 
	 * Merge all established calls (either in {@link State#StreamsRunning} or {@link State#Paused}) into a conference.
	 * 
	**/
...
/**
	...
	**/
	...
	/**
	 * return the version code of org.linphone core
	 */
	public String getVersion();
	
	/**
	 * remove a org.linphone friend from org.linphone core and linphonerc
	 */
	void removeFriend(LinphoneFriend lf);
	
	/**
	 * return a org.linphone friend (if exists) that matches the sip address
	 */
