...
public class LinphoneCoreFactoryImpl extends LinphoneCoreFactory {
	private static final String TAG = "LinphoneCoreFactoryImpl";
	...
	static {
		...
		if (isArmv7()) {
			if (hasNeonInCpuFeatures()) {
				Log.d("org/linphone", "armv7 liblinphone loaded");
				System.loadLibrary("linphonearmv7"); 
			} else {
				Log.w("org/linphone", "No-neon armv7 liblinphone loaded");
				System.loadLibrary("linphonearmv7noneon"); 
			}
		} else if (Version.isX86()) {
			Log.d("org/linphone", "No-neon x86 liblinphone loaded");
			System.loadLibrary("linphonex86"); 
		} else {
			Log.d("org/linphone", "No-neon armv5 liblinphone loaded");
